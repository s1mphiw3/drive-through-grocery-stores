...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, category, details, price, image,vendor_id) VALUES(?,?,?,?,?,?)");
      $insert_products->execute([$name, $category, $details, $price, $image,$vendor_id]);
...
<section class="show-products">
   ...
   <?php
      ...
      $show_products = $conn->prepare("SELECT * FROM `products` where vendor_id=?");
